    ...
    return (
        <div className="home-container">
            <section className="home-section">
                <h2 className="home-title" onClick={() => setIsVisible('difficulty')}>난이도</h2>
                <div className="home-title">{settings.difficulty}</div>
            ...
            <section className="home-section">
                <h2 className="home-title" onClick={() => setIsVisible('bottleSize')}>높이</h2>
                <div className="home-title">{settings.bottleHeight}</div>
                <BottomPicker<number>
                    title="높이"
            ...
            <section className="home-section">
                <h2 className="home-title" onClick={() => setIsVisible('bottleCount')}>색상 수</h2>
                <div className="home-title">{settings.numColors}</div>
                <BottomPicker<number>
                    title="색상 수"
            ...
            <div className="home-buttons">
                <button className="home-button" onClick={handleStartNewGame}>새 게임</button>
                {game && game.length > 0 && (
                    <button className="home-button" onClick={handleResumeGame}>이어하기</button>
                )}
            </div>
        </div>
    )
